    ...
    return (
        <div className="container mt-5">
            ...
            <div className="card shadow-lg p-4">
                ...
                <h3 className="card-subtitle mb-3 text-muted">{additionalData.full_name}</h3>
                <p className="card-text"><strong>Created at:</strong> {new Date(additionalData.created_at).toLocaleDateString()}</p>
                <p className="card-text"><strong>Pushed at:</strong> {new Date(additionalData.pushed_at).toLocaleDateString()}</p>
                <p className="card-text"><strong>Language:</strong> {additionalData.language}</p>
                <div className="text-center mt-4">
                    <Link to={`/pipelines/repository/${repository_id}`} className="btn btn-primary">
                    View Pipelines
                    </Link>
                </div>
                </div>
